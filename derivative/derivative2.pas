...
begin
	...
	Write('f(x) = ');
	InputExpression(e);
	{ Brute differentiation }
	{$IFNDEF NOBRUTE}
	TextColor(Blue);
	Writeln('Brute differentiation:');
	NormVideo;
	DifferentiateExpression(e, 'x', d);
	Writeln('f''(x) = ', ExpressionToStr(d), ' = ', PolyToStr(PolynomialDifferential(e)));
	{$ENDIF}
	{ Polynomial differentiation }
	TextColor(Blue);
	Writeln('Polynomial differentiation:');
	NormVideo;
	Writeln('f''(x) = ', PolyToStr(ExpressionToPoly(d)));
	Writeln;
end.
